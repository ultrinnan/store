...
// Helper function to convert string boolean values to actual boolean
if (!function_exists('getenv_docker_bool')) {
	function getenv_docker_bool($env, $default = false) {
		$val = getenv_docker($env, $default);
 ...
 * @since 2.6.0
 */
// Security keys must be set in environment variables (.env file)
...
if ( WP_DEBUG ) {
	define( 'WP_DEBUG_LOG', getenv_docker_bool('WORDPRESS_DEBUG_LOG', false) );
	define( 'WP_DEBUG_DISPLAY', getenv_docker_bool('WORDPRESS_DEBUG_DISPLAY', false) );
}

define( 'WP_TEST', getenv_docker('WORDPRESS_TEST', 'nooooo') );
