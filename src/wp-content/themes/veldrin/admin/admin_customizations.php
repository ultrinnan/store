...
function admin_css_js() {
  $admin_css_file = get_stylesheet_directory() . '/admin/css/admin_styles.css';
  
  wp_enqueue_style('admin_style', get_stylesheet_directory_uri() .'/admin/css/admin_styles.css', '', file_exists($admin_css_file) ? filemtime($admin_css_file) : '1.0');
}
